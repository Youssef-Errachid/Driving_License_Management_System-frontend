        ...
        <div className="flex-1 bg-[#faf8f5] px-8 py-8">
            <div className="mb-6">
                ...
                <p className="text-sm text-gray-500 mt-1">
                    Consultez tous les examens planifiés et leurs résultats.
                </p>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-3 mb-4">
                <select
                    ...
                    className="px-3 py-2.5 rounded-lg border border-gray-300 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-dlms-navy/30"
                >
                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-sm">
                        ...
                        <tr className="bg-gray-100 text-left text-xs font-semibold uppercase tracking-wide text-gray-500">
                            ...
                            <th className="px-6 py-3 whitespace-nowrap">Date de rendez-vous</th>
                            <th className="px-6 py-3 whitespace-nowrap">Date du résultat</th>
